...
class JobRequirements(models.Model):
    ...
    maximum_relocation_assistance_amount = MoneyField(max_digits=10, decimal_places=2,  default=0.00, default_currency='USD')

    pay_low = MoneyField(max_digits=10, decimal_places=2, default_currency='USD', null=True)
    pay_high = MoneyField(max_digits=10, decimal_places=2, default_currency='USD', null=True)
