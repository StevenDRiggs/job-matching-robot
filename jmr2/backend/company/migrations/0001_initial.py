# Generated by Django 5.1.4 on 2025-02-02 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('benefit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='benefits_available', to='company.benefit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_type', models.CharField(choices=[('fth', 'Full-time'), ('pth', 'Part-time'), ('sal', 'Salary'), ('con', 'Contract'), ('c2h', 'Contract-to-hire'), ('sea', 'Seasonal'), ('oth', 'Other')], max_length=3)),
                ...
                ('pay', djmoney.models.fields.MoneyField(decimal_places=2, max_digits=19)),
                ('pay_frequency', models.CharField(choices=[('h', 'per hour'), ('w', 'per week'), ('b', 'every two weeks'), ('m', 'per month'), ('q', 'every three months'), ('y', 'per year'), ('e', 'per event'), ('o', 'per other (see description)')], max_length=1)),
                ('hours', models.JSONField(default=dict)),
                ('benefits', models.ManyToManyField(through='company.BenefitAvailable', to='company.benefit')),
        ...
        migrations.AddField(
            ...
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='benefits_available', to='company.position'),
        ),
        migrations.CreateModel(
            name='SkillDetail',
            fields=[
