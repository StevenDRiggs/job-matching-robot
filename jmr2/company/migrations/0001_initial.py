# Generated by Django 5.0.7 on 2024-11-26 05:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('benefit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='company.benefit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_frequency', models.CharField(choices=[('h', 'per hour'), ('w', 'per week'), ('b', 'every two weeks'), ('m', 'per month'), ('q', 'every three months'), ('y', 'per year')], max_length=1)),
